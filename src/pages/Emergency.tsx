...
export default function Emergency() {
  ...
  const filteredServices = places.filter(service =>
        ...
        {location ? (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Blue dot = you · <span className="text-red-500 font-semibold">H</span> hospital ·{" "}
                ...
                <Card>
                  <CardContent className="py-10 text-center text-sm text-muted-foreground space-y-2">
                    {!location ? (
                      ...
                      <><Loader2 className="h-8 w-8 mx-auto animate-spin" /><p>Loading nearby services…</p></>
                    ) : (
                      <><MapPin className="h-8 w-8 mx-auto text-muted-foreground/50" />
                        <p className="font-medium text-foreground">No {tab === "all" ? "" : tab} services found nearby</p></>
                    )}
                  </CardContent>
                </Card>
              ) : (
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex gap-2 mt-3">
                                {service.phone && (
                                  <Button size="sm" className="flex-1" onClick={() => dialNumber(service.phone!)}>
